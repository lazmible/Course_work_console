...
#define ATTR_ACCESS_KEY_VALS          ("[0-9a-z]"                      )  // +++++ „исло от 0 до 9 или маленька€ латинска€ буква
#define ATTR_CLASS_VALS               ("([0-9a-zA-Z-_ ]+|)"            )  
#define ATTR_CONTENTEDITABLE_VALS     ("(true|false|)"                 )  // +++++ "true" , "false" или пуста€ строка
#define ATTR_CONTEXTMENU_VALS         ("[a-zA-Z]+"                     )  // !!!!! тут более сложна€ логика, доделать похже
...
#define ATTR_ID_VALS                  ("([a-zA-Z][a-zA-Z0-9-_]*|)"     )  // +++++ Ќачинаетс€ с буквы, дальше буква или цифра или тире или _
#define ATTR_LANG_VALS                LANGUAGE_CODE
#define ATTR_SPELLCHECK_VALS          ("(true|false|)"                 )  // "true" , "false" или пуста€ строка
...
#define ATTR_DOWNLOAD_VALS            ("") // вообще нет и присвоить себе нельз€
...
#define ATTR_LABEL_VALS               ("[a-zA-Z]*") // кавычки об€зательно
...
static std::map<std::string, std::string> ATTR_DATABASE =                                   
{                                                                
