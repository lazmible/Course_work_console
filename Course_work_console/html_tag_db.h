...
#define /*Универсальные*/           ATTR_UNIVERSAL            { "accesskey", "class", "contenteditable", "contextmenu","dir", "hidden", "id", "lang", "spellcheck", "style", "tabindex", "title", "xml:lang" }
#define /*События*/                 ATTR_EVENTS               { "onblur", "onchange", "onclick", "ondblclick", "onfocus", "onkeydown", "onkeypress", "onkeyup", "onload", "onmousedown", "onmousemove", "onmouseout", "onmouseover", "onmouseup", "onreset","onselect", "onsubmit", "onunload" }
#define /*Универсальные и события*/ ATTR_UNIVERSAL_AND_EVENTS {}
